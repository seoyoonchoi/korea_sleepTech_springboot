...
public class BookService {
    ...
    public ResponseDto<BookResponseDto> createBook(BookCreateRequestDto requestDto) {
        ...
        try {
            ...
            return ResponseDto.setSuccess("new book created", response);

        } catch (Exception e) {
            e.printStackTrace();
            return ResponseDto.setFailed("Error not created"+e.getMessage());
        }
    ...
    public ResponseDto<List<BookResponseDto>> getBooksByTitleContaining(String keyword) {
        ...
        try{
            ...
            return ResponseDto.setSuccess("책 검색을 완료하였습니다",books);



        } catch (Exception e) {
            e.printStackTrace();
            return ResponseDto.setFailed("책을 검색하는동안 문제가 발생하였습니다");
        }
    }
    ...
    public ResponseDto<List<BookResponseDto>> getBooksByCategory(C_Category category) {
        ...
        try{
            ...
            return ResponseDto.setSuccess("카테고리별 책 검색을 완료하였습니다",books);
    ...
    public ResponseDto<List<BookResponseDto>> getBooksByCategoryAndWriter(C_Category category, String writer) {
        ...
        try{
            ...
            return ResponseDto.setSuccess("카테고리와 작성자로 책 검색을 완료하였습니다",books);
            ...
            e.printStackTrace();
            return ResponseDto.setFailed("카테고리와 작성자별 책을 검색하는동안 문제가 발생하였습니다");
        }
